...
const SitemapLibrary = () => {
  ...
  const allSitemaps = [
    ...
    ...dbSitemaps
      .filter(d => !seedSitemaps.some(s => s.domain === d.domain))
      .map(d => ({
        domain: d.domain,
        slug: d.slug,
        totalPages: d.total_pages,
        maxDepth: d.max_depth,
        topLevelSections: d.top_level_sections,
      })),
  ];
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          <header className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Browse visual sitemaps of popular websites and explore their architecture.
            </p>
          </header>
          ...
          <div className="text-center py-8 border-t border-border">
            ...
            <p className="text-muted-foreground mb-4">Enter any domain and get a visual sitemap instantly.</p>
