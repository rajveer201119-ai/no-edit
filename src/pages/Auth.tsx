...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 gradient-epic">
      <Card className="w-full max-w-md glass-card border-white/20">
        <CardHeader className="space-y-1">
          <CardTitle className="text-3xl font-bold text-center gradient-epic-text">
            {isLogin ? "Welcome Back" : "Create Account"}
          </CardTitle>
          <CardDescription className="text-center text-muted-foreground">
            {isLogin
              ? "Sign in to access EPIC AI Image Generator"
              : "Sign up to start creating stunning images"}
          </CardDescription>
        </CardHeader>
        <CardContent>
