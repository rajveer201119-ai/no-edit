...
export const templates: Template[] = [
  ...
  // ========== ADDITIONAL CERTIFICATE TEMPLATES ==========
  {
   ...
   // ========== FLYER TEMPLATES ==========
   {
     ...
     canvasHeight: 1200,
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 800, height: 1200, backgroundColor: "#1c1917" },
       { id: "accent-top", type: "shape", x: 0, y: 0, width: 800, height: 400, backgroundColor: "#b91c1c" },
       { id: "title", type: "text", x: 50, y: 80, width: 700, height: 150, content: "GRAND\nOPENING", fontSize: 80, fontWeight: "bold", color: "#ffffff" },
       { id: "restaurant", type: "text", x: 50, y: 280, width: 700, height: 60, content: "THE GRILL HOUSE", fontSize: 36, fontWeight: "bold", color: "#fecaca" },
       { id: "offer", type: "shape", x: 50, y: 450, width: 700, height: 200, backgroundColor: "#fbbf24", borderRadius: 20 },
       { id: "offer-text", type: "text", x: 100, y: 490, width: 600, height: 120, content: "FREE APPETIZER\nWith Any Entrée", fontSize: 42, fontWeight: "bold", color: "#1c1917" },
       { id: "valid", type: "text", x: 50, y: 700, width: 700, height: 40, content: "Valid: March 1-15, 2024", fontSize: 20, color: "#a1a1aa" },
       { id: "address", type: "text", x: 50, y: 800, width: 700, height: 80, content: "📍 123 Main Street\n📞 (555) 123-4567", fontSize: 24, color: "#d6d3d1" },
       { id: "hours", type: "text", x: 50, y: 950, width: 700, height: 50, content: "Open Daily: 11AM - 10PM", fontSize: 18, color: "#78716c" },
       { id: "social", type: "text", x: 50, y: 1050, width: 700, height: 40, content: "@thegrillhouse • thegrillhouse.com", fontSize: 16, color: "#525252" },
     ],
   },
   {
     id: "flyer-gym",
     ...
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 800, height: 1200, backgroundColor: "#0a0a0a" },
       { id: "accent", type: "shape", x: 0, y: 0, width: 8, height: 1200, backgroundColor: "#22c55e" },
       { id: "badge", type: "shape", x: 50, y: 50, width: 200, height: 50, backgroundColor: "#22c55e", borderRadius: 25 },
       { id: "badge-text", type: "text", x: 70, y: 60, width: 160, height: 30, content: "LIMITED OFFER", fontSize: 14, fontWeight: "bold", color: "#0a0a0a" },
       { id: "headline", type: "text", x: 50, y: 200, width: 700, height: 200, content: "GET FIT\nFOR LESS", fontSize: 80, fontWeight: "bold", color: "#ffffff" },
       { id: "price", type: "text", x: 50, y: 450, width: 400, height: 120, content: "$19/mo", fontSize: 72, fontWeight: "bold", color: "#22c55e" },
       { id: "regular", type: "text", x: 50, y: 560, width: 400, height: 40, content: "Reg. $49/month", fontSize: 20, color: "#71717a" },
       { id: "features", type: "text", x: 50, y: 650, width: 700, height: 200, content: "✓ Unlimited gym access\n✓ Free personal training\n✓ All group classes\n✓ Locker included", fontSize: 24, color: "#d4d4d4" },
       { id: "cta", type: "shape", x: 50, y: 920, width: 400, height: 70, backgroundColor: "#22c55e", borderRadius: 12 },
       { id: "cta-text", type: "text", x: 100, y: 935, width: 300, height: 40, content: "Join Now →", fontSize: 24, fontWeight: "bold", color: "#0a0a0a" },
       { id: "expires", type: "text", x: 50, y: 1050, width: 700, height: 40, content: "Offer expires March 31st", fontSize: 16, color: "#525252" },
     ],
   },
   ...
   // ========== APP PROMO TEMPLATES ==========
   {
     ...
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 1080, height: 1080, backgroundColor: "#0f172a" },
       { id: "glow1", type: "shape", x: -100, y: 200, width: 600, height: 600, backgroundColor: "#3b82f6", borderRadius: 300 },
       { id: "glow2", type: "shape", x: 600, y: 400, width: 500, height: 500, backgroundColor: "#8b5cf6", borderRadius: 250 },
       { id: "phone-bg", type: "shape", x: 340, y: 250, width: 400, height: 600, backgroundColor: "#1e293b", borderRadius: 40 },
       { id: "phone-screen", type: "shape", x: 355, y: 270, width: 370, height: 560, backgroundColor: "#0f172a", borderRadius: 30 },
       { id: "title", type: "text", x: 80, y: 80, width: 920, height: 100, content: "NOW AVAILABLE", fontSize: 32, fontWeight: "bold", color: "#94a3b8" },
       { id: "app-name", type: "text", x: 80, y: 900, width: 920, height: 80, content: "Download the App", fontSize: 48, fontWeight: "bold", color: "#ffffff" },
       { id: "stores", type: "text", x: 80, y: 1000, width: 920, height: 40, content: "App Store • Google Play", fontSize: 24, color: "#64748b" },
     ],
   },
   {
     id: "startup-promo",
     ...
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 1080, height: 1080, backgroundColor: "#fafafa" },
       { id: "accent-block", type: "shape", x: 0, y: 800, width: 1080, height: 280, backgroundColor: "#18181b" },
       { id: "logo-area", type: "shape", x: 80, y: 80, width: 80, height: 80, backgroundColor: "#3b82f6", borderRadius: 16 },
       { id: "tagline", type: "text", x: 80, y: 220, width: 920, height: 200, content: "The future of\nproductivity is here", fontSize: 64, fontWeight: "bold", color: "#18181b" },
       { id: "desc", type: "text", x: 80, y: 480, width: 700, height: 100, content: "AI-powered tools that help you work smarter, not harder.", fontSize: 28, color: "#52525b" },
       { id: "metric1", type: "text", x: 80, y: 640, width: 300, height: 60, content: "10x Faster", fontSize: 36, fontWeight: "bold", color: "#3b82f6" },
       { id: "metric2", type: "text", x: 400, y: 640, width: 300, height: 60, content: "50% Cost Cut", fontSize: 36, fontWeight: "bold", color: "#3b82f6" },
       { id: "cta", type: "text", x: 80, y: 860, width: 920, height: 60, content: "Join 10,000+ teams →", fontSize: 28, fontWeight: "bold", color: "#ffffff" },
       { id: "website", type: "text", x: 80, y: 960, width: 400, height: 40, content: "yourproduct.com", fontSize: 20, color: "#a1a1aa" },
     ],
   },
   ...
   // ========== SCHOOL/EDUCATION TEMPLATES ==========
   {
     ...
     canvasHeight: 1200,
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 800, height: 1200, backgroundColor: "#1e40af" },
       { id: "wave", type: "shape", x: 0, y: 600, width: 800, height: 600, backgroundColor: "#1d4ed8" },
       { id: "title", type: "text", x: 50, y: 80, width: 700, height: 150, content: "SCIENCE\nFAIR 2024", fontSize: 72, fontWeight: "bold", color: "#ffffff" },
       { id: "school", type: "text", x: 50, y: 280, width: 700, height: 50, content: "Lincoln High School Presents", fontSize: 22, color: "#bfdbfe" },
       { id: "emoji", type: "text", x: 300, y: 380, width: 200, height: 150, content: "🔬", fontSize: 120, color: "#ffffff" },
       { id: "details", type: "text", x: 50, y: 600, width: 700, height: 150, content: "Join us for an amazing\nday of discovery!", fontSize: 32, color: "#ffffff" },
       { id: "date", type: "text", x: 50, y: 800, width: 700, height: 60, content: "📅 March 22, 2024", fontSize: 28, fontWeight: "bold", color: "#fbbf24" },
       { id: "time", type: "text", x: 50, y: 870, width: 700, height: 50, content: "⏰ 9:00 AM - 3:00 PM", fontSize: 24, color: "#bfdbfe" },
       { id: "location", type: "text", x: 50, y: 940, width: 700, height: 50, content: "📍 Main Gymnasium", fontSize: 24, color: "#bfdbfe" },
       { id: "free", type: "shape", x: 250, y: 1050, width: 300, height: 60, backgroundColor: "#fbbf24", borderRadius: 30 },
       { id: "free-text", type: "text", x: 280, y: 1065, width: 240, height: 30, content: "FREE ADMISSION", fontSize: 18, fontWeight: "bold", color: "#1e40af" },
     ],
   },
   {
     id: "graduation-poster",
     name: "Graduation",
     category: "poster",
     thumbnailUrl: "",
     canvasWidth: 800,
     canvasHeight: 1200,
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 800, height: 1200, backgroundColor: "#0c0a09" },
       { id: "gold-accent", type: "shape", x: 0, y: 0, width: 800, height: 400, backgroundColor: "#b45309" },
       { id: "cap", type: "text", x: 280, y: 80, width: 240, height: 200, content: "🎓", fontSize: 150, color: "#ffffff" },
       { id: "congrats", type: "text", x: 50, y: 320, width: 700, height: 60, content: "CONGRATULATIONS", fontSize: 32, fontWeight: "bold", color: "#fbbf24" },
       { id: "class", type: "text", x: 50, y: 450, width: 700, height: 150, content: "CLASS OF\n2024", fontSize: 80, fontWeight: "bold", color: "#ffffff" },
       { id: "school", type: "text", x: 50, y: 650, width: 700, height: 50, content: "Central High School", fontSize: 28, color: "#a8a29e" },
       { id: "date", type: "text", x: 50, y: 750, width: 700, height: 50, content: "June 15, 2024 • 4:00 PM", fontSize: 24, color: "#78716c" },
       { id: "venue", type: "text", x: 50, y: 820, width: 700, height: 50, content: "City Convention Center", fontSize: 22, color: "#78716c" },
       { id: "divider", type: "shape", x: 300, y: 920, width: 200, height: 2, backgroundColor: "#b45309" },
       { id: "message", type: "text", x: 50, y: 980, width: 700, height: 80, content: "Your future starts now!", fontSize: 24, color: "#d6d3d1" },
     ],
   },
   ...
   // ========== E-COMMERCE TEMPLATES ==========
   {
     ...
     canvasHeight: 1080,
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 1080, height: 1080, backgroundColor: "#f5f5f4" },
       { id: "product-zone", type: "shape", x: 140, y: 150, width: 800, height: 600, backgroundColor: "#e7e5e4", borderRadius: 40 },
       { id: "new-badge", type: "shape", x: 80, y: 80, width: 140, height: 50, backgroundColor: "#18181b", borderRadius: 25 },
       { id: "new-text", type: "text", x: 100, y: 90, width: 100, height: 30, content: "NEW", fontSize: 18, fontWeight: "bold", color: "#ffffff" },
       { id: "product-name", type: "text", x: 80, y: 800, width: 920, height: 80, content: "Product Name", fontSize: 48, fontWeight: "bold", color: "#18181b" },
       { id: "price", type: "text", x: 80, y: 890, width: 300, height: 60, content: "$129.00", fontSize: 36, fontWeight: "bold", color: "#18181b" },
       { id: "shop-btn", type: "shape", x: 600, y: 880, width: 400, height: 70, backgroundColor: "#18181b", borderRadius: 35 },
       { id: "shop-text", type: "text", x: 700, y: 895, width: 200, height: 40, content: "Shop Now", fontSize: 20, fontWeight: "bold", color: "#ffffff" },
     ],
   },
   {
     id: "sale-banner",
     ...
     canvasHeight: 1080,
     elements: [
       { id: "bg", type: "shape", x: 0, y: 0, width: 1080, height: 1080, backgroundColor: "#000000" },
       { id: "stripe1", type: "shape", x: -50, y: 150, width: 1200, height: 80, backgroundColor: "#dc2626" },
       { id: "stripe2", type: "shape", x: -50, y: 850, width: 1200, height: 80, backgroundColor: "#dc2626" },
       { id: "main-text", type: "text", x: 80, y: 350, width: 920, height: 200, content: "BLACK\nFRIDAY", fontSize: 120, fontWeight: "bold", color: "#ffffff" },
       { id: "discount", type: "text", x: 80, y: 580, width: 920, height: 120, content: "UP TO 70% OFF", fontSize: 56, fontWeight: "bold", color: "#fbbf24" },
       { id: "dates", type: "text", x: 80, y: 750, width: 920, height: 50, content: "November 24-27 Only", fontSize: 24, color: "#a1a1aa" },
       { id: "code", type: "text", x: 80, y: 960, width: 920, height: 40, content: "Use Code: SAVE70", fontSize: 20, fontWeight: "bold", color: "#dc2626" },
     ],
   },
];
